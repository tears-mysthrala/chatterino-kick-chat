...
cp -r "$ROOT/src" "$ROOT/init.lua" "$ROOT/info.json" "$ROOT/LICENSE" "$ROOT/SECURITY.md" "$ROOT/install-or-update.cmd" "$DIST/package/"
cp "$ROOT/scripts/install.ps1" "$DIST/package/scripts/"
cd "$DIST/package"
